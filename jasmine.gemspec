...
Gem::Specification.new do |s|
  ...
  s.date = "2013-01-10"
  s.description = "Javascript BDD test framework"
  ...
  s.files = [
    "generators/jasmine/jasmine_generator.rb",
     ...
     "generators/jasmine/templates/jasmine-example/spec/SongSpek.js",
     ...
     "generators/jasmine/templates/spec/javascripts/FooSpec_.js",
  ...
  s.homepage = "http://github.com/pivotal/jasmine-ruby"
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = "1.8.24"
  s.summary = "Jasmine Ruby Runner"
  s.test_files = [
    "spec/config_spec.rb",
